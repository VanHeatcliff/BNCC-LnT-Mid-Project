...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($_POST['first_name']) || empty($_POST['last_name']) || empty($_POST['email'])) {
      echo "<script>alert('Harap isi semua field kecuali bio!'); window.history.back();</script>";
      exit; 
    }
    ...
    $sql = "INSERT INTO users (first_name, last_name, email, bio, photo) VALUES ('$firstName', '$lastName', '$email', '$bio', '$photoPath')";
...
<section class="bg-white dark:bg-gray-900">
  <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
    <aside class="relative block h-16 lg:order-last lg:col-span-5 lg:h-full xl:col-span-6">
      <img
        alt=""
        src="uploads/WhatsApp Image 2025-02-08 at 15.10.24.jpeg"
    ...
    >
      <div class="max-w-xl lg:max-w-3xl">
        ...
        <form method="POST" action="" class="mt-8 grid grid-cols-6 gap-6" enctype="multipart/form-data">
          ...
          <div class="col-span-6 sm:flex sm:items-center sm:gap-4">
            ...
            >
              ...
              <a href="index.php" class="text-gray-700 underline dark:text-gray-200">Cancel</a>.
            </p>
          </div>
        </form>
      </div>
